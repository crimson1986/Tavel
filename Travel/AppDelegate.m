...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    [self initializeTabbarWithControllers];
...
- (void)initializeTabbarWithControllers {
    ...
    [self.tabbarController setViewControllers:[NSArray arrayWithObjects:navMenu,navProfile, nil] animated:NO];
}
@end
